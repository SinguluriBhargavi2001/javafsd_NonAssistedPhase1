...
public class Virtual_Key {
	//welcome Screen
	 private static void welcomeScreen() {
		 ...
		 System.out.println("Developer Details: Singuluri Bhargavi\n");
		 System.out.println("********************************************************************");
     }
	 ...
	 private static final String options="1 : Sort the file names in ascending order\n2 : Perform add, delete or search operations\n3 : Close the application";
	 ...
	 void searchFile(String searchfile) {
		 ...
		 for (String fileName: list) {
			 ...
			 if (searchfile.equals(fileName)) {
				 ...
				 System.out.println(searchfile + " is present at location: " + folder);
				 return;
				 }
			 }
	 ...
	 public static void main(String[] args) {
		 ...
		 //static method
		 welcomeScreen();
		 Virtual_Key VR = new Virtual_Key();
